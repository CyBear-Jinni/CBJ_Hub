...
final $typed_data.Uint8List vendorsAndServicesDescriptor = $convert.base64Decode(
    'ChJWZW5kb3JzQW5kU2VydmljZXMSIgoedmVuZG9yc0FuZFNlcnZpY2VzTm90U3VwcG9ydGVkEAASCwoHZXNwSG9tZRABEgwKCHN3aXRjaGVyEAISCwoHdGFzbW90YRADEgwKCHllZWxpZ2h0EAQSCgoGZ29vZ2xlEAUSDgoKeGlhb21pTWlpbxAG');
...
final $typed_data.Uint8List deviceTypesDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deviceStateGRPCDescriptor = $convert.base64Decode(
    'Cg9EZXZpY2VTdGF0ZUdSUEMSFQoRc3RhdGVOb3RTdXBwb3J0ZWQQABIYChRjYW5jZWxTdGF0ZUluUHJvY2VzcxABEgcKA2FjaxACEhIKDm5ld1N0YXRlRmFpbGVkEAMSFQoRd2FpdGluZ0luRmlyZWJhc2UQBBIRCg13YWl0aW5nSW5Db21wEAU=');
...
final $typed_data.Uint8List sendingTypeDescriptor = $convert.base64Decode(
    'CgtTZW5kaW5nVHlwZRIRCg11bmRlZmluZWRUeXBlEAASDgoKc3RyaW5nVHlwZRABEhUKEXBhcnRpYWxEZXZpY2VUeXBlEAISDgoKZGV2aWNlVHlwZRADEhMKD21xdHRNYXNzYWdlVHlwZRAEEg0KCXNjZW5lVHlwZRAFEhAKDHNjaGVkdWxlVHlwZRAGEg8KC3JvdXRpbmVUeXBlEAcSEAoMYmluZGluZ3NUeXBlEAg=');
...
final $typed_data.Uint8List firstSetupMessageDescriptor = $convert.base64Decode(
    'ChFGaXJzdFNldHVwTWVzc2FnZRIsCghjb21wSW5mbxgmIAEoCzIQLkNiakh1Yi5Db21wSW5mb1IIY29tcEluZm8SYgoaZmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb24YJyABKAsyIi5DYmpIdWIuRmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb25SGmZpcmViYXNlQWNjb3VudEluZm9ybWF0aW9u');
...
final $typed_data.Uint8List compInfoDescriptor = $convert.base64Decode(
    'CghDb21wSW5mbxIvCgljb21wU3BlY3MYFSABKAsyES5DYmpIdWIuQ29tcFNwZWNzUgljb21wU3BlY3MSRwoSc21hcnREZXZpY2VzSW5Db21wGBwgAygLMhcuQ2JqSHViLlNtYXJ0RGV2aWNlSW5mb1ISc21hcnREZXZpY2VzSW5Db21w');
...
final $typed_data.Uint8List smartDeviceInfoDescriptor = $convert.base64Decode(
    '');
