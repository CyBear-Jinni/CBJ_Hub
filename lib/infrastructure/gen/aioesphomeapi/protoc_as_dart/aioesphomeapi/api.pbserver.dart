...
abstract class APIConnectionServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$1.ConnectResponse> connect(
      $pb.ServerContext ctx, $1.ConnectRequest request);
  ...
  $async.Future<$1.GetTimeResponse> get_time(
      $pb.ServerContext ctx, $1.GetTimeRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'hello':
        return this.hello(ctx, request as $1.HelloRequest);
      case 'connect':
        return this.connect(ctx, request as $1.ConnectRequest);
      case 'disconnect':
        return this.disconnect(ctx, request as $1.DisconnectRequest);
      case 'ping':
        return this.ping(ctx, request as $1.PingRequest);
      case 'device_info':
        return this.device_info(ctx, request as $1.DeviceInfoRequest);
      case 'list_entities':
        return this.list_entities(ctx, request as $1.ListEntitiesRequest);
      case 'subscribe_states':
        return this.subscribe_states(ctx, request as $1.SubscribeStatesRequest);
      case 'subscribe_logs':
        return this.subscribe_logs(ctx, request as $1.SubscribeLogsRequest);
      case 'subscribe_homeassistant_services':
        return this.subscribe_homeassistant_services(
            ctx, request as $1.SubscribeHomeassistantServicesRequest);
      case 'subscribe_home_assistant_states':
        return this.subscribe_home_assistant_states(
            ctx, request as $1.SubscribeHomeAssistantStatesRequest);
      case 'get_time':
        return this.get_time(ctx, request as $1.GetTimeRequest);
      case 'execute_service':
        return this.execute_service(ctx, request as $1.ExecuteServiceRequest);
      case 'cover_command':
        return this.cover_command(ctx, request as $1.CoverCommandRequest);
      case 'fan_command':
        return this.fan_command(ctx, request as $1.FanCommandRequest);
      case 'light_command':
        return this.light_command(ctx, request as $1.LightCommandRequest);
      case 'switch_command':
        return this.switch_command(ctx, request as $1.SwitchCommandRequest);
      case 'camera_image':
        return this.camera_image(ctx, request as $1.CameraImageRequest);
      case 'climate_command':
        return this.climate_command(ctx, request as $1.ClimateCommandRequest);
      case 'number_command':
        return this.number_command(ctx, request as $1.NumberCommandRequest);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
